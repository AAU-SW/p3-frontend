...
export const AssetsBaseData: FC<AssetsBaseDataProps> = ({data}) => {
    ...
    return (
        <>
            <Card className="w-full max-w-md shadow-md border border-gray-200 pt-0">
                ...
                <CardContent>
                    <div className="grid grid-cols-2">
                        <div className="col-span-1 flex flex-col">
                            <span
                                className="text-xs font-semibold text-gray-500 uppercase mb-2">Registration number</span>
                            <span className=" font-medium">{data.imei}</span>
                        </div>
                        <div className="col-span-1 flex flex-col">
                            <span
                                className="text-xs font-semibold text-gray-500 uppercase mb-2">ID</span>
                            <span className="mb-4 font-medium">{data.id}</span>
                        </div>
                    </div>
                    <Separator className="mt-2"/>
                    <div className="grid grid-cols-2 mt-2">
                        <div className="col-span-1 flex flex-col">
                            <span className="text-xs mt-4 font-semibold text-gray-500 uppercase mb-2"> created</span>
                            <span className="mb-4 font-medium">{data.createdAt}</span>

                            <span className="text-xs font-semibold text-gray-500 uppercase mb-2"> Updated by</span>
                            <span className="mb-4 font-medium">{data.updatedBy}</span>
                        </div>
                        <div className="col-span-1 flex flex-col">
                            <span
                                className="text-xs mt-4 font-semibold text-gray-500 uppercase mb-2">Last updated</span>
                            <span className="mb-4 font-medium">{data.updatedAt}</span>

                            <span className="text-xs font-semibold text-gray-500 uppercase mb-2">Last invoiced</span>
                            <span className="mb-4 font-medium">{data.lastInvoiced}</span>
                        </div>
                    </div>
                </CardContent>
            </Card>
